...
<body>
    ...
    <div class="body-inner">
                        ...
                        <div class="container">
                            <nav id="navbar" class="navbar">
                                <ul id="menu_item">
                                    ...
                                    <li><a class="list_item scrollto" href="#about-event">About the Event</a></li>
                                    <li><a class="list_item scrollto" href="#coming-soon">About Saudi Arabia</a></li>
                                    <li><a class="list_item scrollto" href="#coming-soon">The Banks</a></li>
                                    <li><a class="list_item scrollto" href="#coming-soon">Media</a></li>
                                    <li><a class="list_item scrollto" href="#invitation">Secure Invitation</a></li>
                                    <li><a class="list_item scrollto" href="#coming-soon">News</a></li>
                                    <li><a class="list_item scrollto" href="#contact-us">Contact Us</a></li>
        ...
        <div id="slider" class="inspiro-slider slider-fullscreen dots" data-height-xs="360">
            ...
            <div class="slide" data-bg-image="images/sliders/slider1.png">
                ...
                <div class="container">
                    ...
                    <div class="slide-captions text-light" style="padding-top:10%;">
                        <div class="silelogo col-sm-12 col-md-6 col-lg-4">
                            <div>
                                <img src="images/logo/logo-w.png" class="img_logo" alt="logo">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-4 font-aileron">
                            <p style="font-family: lintel-medium; font-size: 14px; font-weight: bold; margin: 0;">October 23, 2024<br><span style="display: inline-block; border-bottom: 2px solid white; padding-bottom: 3px;">Fairmont 2401 M St NW, Washington, D.C</span></p>
                            <p style="font-family: lintel-medium; font-size: 14px; font-weight: bold; border-bottom: 2px solid white; padding-bottom: 3px; display: inline-block;">7:00PM to 9:00PM</p>
                        </div>
            ...
            <div class="slide" data-bg-image="images/sliders/slider2.png">
                <div class="bg-overlay"></div>
                <div class="container">
                    <div class="slide-captions text-light" style="padding-top:27%;">
                        <!-- Captions -->
                        <div class="silelogo col-sm-12 col-md-6 col-lg-4">
                            <div>
                                <img src="images/logo/logo-w.png" class="img_logo" alt="logo">
            ...
            <div class="slide" data-bg-image="images/sliders/slider4.png">
                <div class="bg-overlay"></div>
                <div class="container">
                    <div class="slide-captions text-light" style="padding-top:17%;">
                        <!-- Captions -->
                        <div class="silelogo col-sm-12 col-md-6 col-lg-4">
                            <div>
                                <img src="images/logo/logo-w.png" class="img_logo" alt="logo">
        ...
        <!-- About Event -->
        <section id="about-event" class="fullscreen text-light" style="background: transparent url(images/bg-about-event.jpg); background-repeat: no-repeat; background-size: cover; background-position: bottom;">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-7 text-light sec-para ">
                    ...
                    <div class="col-md-6">
                        <div class="silelogo animate__fadeInUp about_logo_bx" style="opacity: 1; animation-duration: 600ms;">
                            <div class="d-md-flex">
                            <div>
                                <img src="images/logo/logo-c.png" class="img_logo" alt="logo">
                            </div>
                            </div>
                            <div class="abou_logo_txt">
                                <p style="font-family: lintel-bold; font-weight:bold; font-size: 14px; margin: 0; text-align: left;">October 23, 2024 <span style="display: inline-block; border-bottom: 2px solid #E9Af85; padding-bottom: 3px;">Fairmont 2401 M St NW, Washington, D.C</span></p>
                                <p style="font-family: lintel-bold; font-weight:bold; font-size: 14px; margin: 0; text-align: left; border-bottom: 2px solid #E9Af85; padding-bottom: 3px; display: inline-block;">7:00PM to 9:00PM</p>
                            </div>
                        </div>
        ...
        <!-- end: About Event -->
        <!-- About KSA -->
        <section id="about-saudi-arabia" class="fullscreen text-light" style="background: transparent url(images/bg-about-ksa.jpg); background-repeat: no-repeat; background-size: cover; background-position: bottom;">
            <div class="top-border"></div>
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 p-t-60">
                        <!-- <img  src="images/triangles/green-blue.png" height="120" /> -->
                    </div>
                </div>
            </div>
            <div class="bottom-border"></div>
        ...
        <!-- media sectin -->
        <section id="media" class="display: none; page-content fullscreen text-light background-colored" style="display: none;" >
            <div class="container grid-special justify-content-between">
        ...
        <!-- secure invitation -->
        <section id="invitation" class="fullscreen background-white">
            <div class="container secure-invitation row justify-content-between">
                <div class="col-sm-12 col-md-12 col-lg-6">
                    ...
                    <form class="widget-contact-form" data-success-message-delay="40000" novalidate action="include/contact-form.php" method="POST">
                        <p><?php if($_SESSION["form_submit"]=='success'){ echo "Email Successfully Sent!";session_destroy ();}elseif($_SESSION["form_submit"]=='error'){ echo "Some Server Error Occurs";session_destroy ();}?></p>
        ...
        <!-- News -->
        <section id="news" class="fullscreen text-light background-colored" style="background: transparent url(images/newsbg.png); background-repeat: no-repeat; position: relative; background-size: cover; background-position: bottom; ">
            <div class="container ">
                <div class="row justify-content-between align-items-center">
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="annual_meeting_btns">
                            <a class="an_meeting">Annual Meeting</a>
                            <span class="an_date">09 - 15 Oct 23</span> 
                        </div>
                    </div>
                ...
                <div class="row sm_news">
                    <div class="news_post col-sm-12 col-md-6 col-lg-4">
                        <div class="post-item-wrap">
                            <div class="post-image">
                                <a target="_blank" href="https://www.worldbank.org/en/meetings/splash/annual"><img alt="" src="images/news1.png"></a>
                            </div>
                            <div class="post-item-description">
                                <button type="button" class="btn btn-roundeded btn-outline" style="border-color: #fff; color: #fff; font-family: 'lintel-medium'; letter-spacing: 0.6px;font-size: 10px;font-weight: 400;">Annual Meeting</button>
                                <button type="button" class="btn btn-roundeded btn-outline" style="border-color: #fff; color: #fff; font-family: 'lintel-medium'; letter-spacing: 0.6px;font-size: 10px;font-weight: 400;">10 - 16 Oct 22</button>
                                <p class="sec-para">The 2023 Annual Meetings of the World Bank Group and the International Monetary Fund (IMF) will take place in person from Monday, October 9, through Sunday, October 15 in Marrakech, Morocco. The theme for the Annual Meetings will be “Global Action, Global Impact”.</p>
                                 <!--<p>https://www.worldbank.org/en/meetings/splash/annual</p> -->
                                <div class="news_btns"><img src="images/triangles/blue.png" alt="blue" style="width: 20%;"><a target="_blank" href="https://www.imf.org/en/News/Seminars/Campaigns/2023/Marrakech2023" class="item-link sec-para">Discover More <i class="icon-chevron-right"></i></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="news_post col-sm-12 col-md-6 col-lg-4">
                        <div class="post-item-wrap">
                            <div class="post-image">
                                <a target="_blank" href="https://www.vision2030.gov.sa/v2030/achievements/"><img alt="" src="images/news2.png"></a>
                            </div>
                            <div class="post-item-description">
                                <button type="button" class="btn btn-roundeded btn-outline" style="border-color: #fff; color: #fff; font-family: 'lintel-medium'; letter-spacing: 0.6px;font-size: 10px;font-weight: 400;">Vision 2030</button>
                                <button type="button" class="btn btn-roundeded btn-outline" style="border-color: #fff; color: #fff; font-family: 'lintel-medium'; letter-spacing: 0.6px;font-size: 10px;font-weight: 400;">Achievements</button>
                                <p class="sec-para">Five years after Vision 2030 was unveiled, many noteworthy achievements have been made to support the Kingdom’s economic diversification objectives and build a prosperous future for the people of Saudi Arabia. The Vision Realization Programs have achieved remarkable successes across the vision's pillars.</p>
                                 <!--<p>https://www.vision2030.gov.sa/v2030/achievements/</p> -->
                                <div class="news_btns"><img src="images/triangles/pinkd.png" alt="blue" style="width: 20%;"><a target="_blank" href="https://www.vision2030.gov.sa/v2030/achievements/" class="item-link sec-para">Discover More <i class="icon-chevron-right"></i>
                                </a></div>
                            </div>
                        </div>
                    </div>
                    <div class="news_post col-sm-12 col-md-6 col-lg-4">
                        <div class="post-item-wrap">
                            <div class="post-image">
                                <a target="_blank" href="https://www.visitsaudi.com/en"><img alt="" src="images/news3.png"></a>
                            </div>
                            <div class="post-item-description">
                                <button type="button" class="btn btn-roundeded btn-outline" style="border-color: #fff; color: #fff; font-family: 'lintel-medium'; letter-spacing: 0.6px;font-size: 10px;font-weight: 400;">Visit Saudi</button>
                                <button type="button" class="btn btn-roundeded btn-outline" style="border-color: #fff; color: #fff; font-family: 'lintel-medium'; letter-spacing: 0.6px;font-size: 10px;font-weight: 400;">e-Visa</button>
                                <p class="sec-para">Saudi Arabia is opening its doors to the world through its new tourist visa. Visitor will have the chance to discover and experience the warm hospitality of the Saudi people, the rich heritage, the vibrant culture, and Saudi Arabia's diverse and breathtaking landscapes.</p>
                                <br/>
                                 <!--<p>https://www.visitsaudi.com/en</p> -->
                                <div class="news_btns">
                                    <img src="images/triangles/greend.png" alt="blue" style="width: 20%;"><a target="_blank" href="https://www.visitsaudi.com/en" class="item-link sec-para">Discover More <i class="icon-chevron-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid-layout post-3-columns m-b-10" data-item="post-item">
                    ...
                    <div class="post-item news_post col-sm-12 col-md-6 col-lg-4">
                        <div class="post-item-wrap">
                            <div class="post-image">
                                <a target="_blank" href="https://www.worldbank.org/en/meetings/splash/annual"><img alt="" src="images/news1d.png"></a>
                            </div>
                            <div class="post-item-description">
                                <button type="button" class="btn btn-roundeded btn-outline" style="border-color: #fff; color: #fff; font-family: 'lintel-medium'; letter-spacing: 0.6px;font-size: 10px;font-weight: 400;">Annual Meeting</button>
                                <button type="button" class="btn btn-roundeded btn-outline" style="border-color: #fff; color: #fff; font-family: 'lintel-medium'; letter-spacing: 0.6px;font-size: 10px;font-weight: 400;">10 - 16 Oct 22</button>
                    ...
                    <div class="post-item news_post col-sm-12 col-md-6 col-lg-4">
                        <div class="post-item-wrap">
                            <div class="post-image">
                                <a target="_blank" href="https://www.vision2030.gov.sa/v2030/achievements/"><img alt="" src="images/news2d.png"></a>
                            </div>
                            <div class="post-item-description">
                                <button type="button" class="btn btn-roundeded btn-outline" style="border-color: #fff; color: #fff; font-family: 'lintel-medium'; letter-spacing: 0.6px;font-size: 10px;font-weight: 400;">Vision 2030</button>
                                <button type="button" class="btn btn-roundeded btn-outline" style="border-color: #fff; color: #fff; font-family: 'lintel-medium'; letter-spacing: 0.6px;font-size: 10px;font-weight: 400;">Achievements</button>
        ...
        <!-- contact us section -->
        <section id="contact-us" class="fullscreen  background-white">
                <div class="container bbdr d-md-flex justify-content-between">
                    <div class="col-md-6" style="font-family: lintel;">
                        <div>
                                <p>Saudi Banks Joint Reception</p>
                                <p>Fairmont 2401 M St NW, Washington, D.C.</p>
                        </div>
                        <div class="d-md-flex">
                            <div class="contact text-light text-sm-center col-md-4 d-flex align-items-center justify-content-center my-2"
                                    style="background-color:#2F8C95">
                                    <ap>Event location</ap>
                            </div>
                            <div class="col-md-1"></div>
                            <div class="contact text-light text-sm-center col-md-4 d-flex align-items-center justify-content-center my-2"
                                    style="background-color:#2F8C95">
                                    <ap>October 23, 2024</ap>
                            </div>
                        </div>
                        <div class="contact text-light text-sm-center col-md-9 align-items-center justify-content-center my-2" style="background-color:#2F8C95">
                        ...
                        <div class="bdr py-3">
                            ...
                            <div class="d-md-flex align-items-center">
                                <div class="col-md-3">
                                    <div class="my-1 contact text-light text-sm-center"
                                            style="background-color:#2F8C95">
                                            <ap>Email</ap>
                                    </div>
                                </div>
                                <div>
                                    <div class="mx-md-5">
                                            <ap>info@saudibanksjointreception.com</ap>
                                    </div>
                                </div>
                            </div>
                            <div class="d-md-flex align-items-center">
                        ...
                        <div>
                            ...
                            <form class="widget-contact-form" data-success-message-delay="40000" novalidate action="include/contact-form.php" method="POST" style="font-family: lintel;">
                                ...
                                <div class="d-md-flex justify-content-between ">
                                    <div class="col-md-3">
                                        <label for="your-name" class="text-light form-label2  p-2" style="background-color:#2F8C95"> Your Name </label>
                                    </div>
                                    <div  class="col-md-8">
                                ...
                                <div class="d-md-flex justify-content-between ">
                                    <div class="col-md-3">
                                        <label for="your-email" class="text-light form-label2 p-2" style="background-color:#2F8C95"> Your Email </label>
                                    </div>
                                    <div  class="col-md-8">
                                ...
                                <div class="d-md-flex justify-content-between">
                                    <div class="col-md-3">
                                        <label for="message" class="text-light form-label2 p-2" style="background-color:#2F8C95">Your Message</label>
                                    </div>
                                    <div class="col-md-8">
        ...
        <!-- BLOG -->
        <section id="media" class="fullscreen text-light" style="display: none; background: transparent url(images/3.jpg);">
