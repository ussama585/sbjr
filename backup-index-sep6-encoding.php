...
<body>
    ...
    <div class="body-inner">
        ...
        <!-- Inspiro Slider -->
        <div id="slider" class="inspiro-slider slider-fullscreen dots">
            <!-- Slide 1 -->
                    ...
                    <div class="col-md-6">
                        <div class="silelogo animate__fadeInUp about_logo_bx" style="opacity: 1; animation-duration: 600ms;">
                            ...
                            <div class="abou_logo_txt">
                                <p style="font-family: lintel-bold; font-weight:bold; font-size: 15px; margin: 0; text-align: left;">October 23, 2024 <span style="display: inline-block; border-bottom: 2px solid #E9Af85; padding-bottom: 1px;">Fairmont 2401 M St NW, Washington, D.C</span></p>
                                <p style="font-family: lintel-bold; font-weight:bold; font-size: 15px; margin: 0; text-align: left; border-bottom: 2px solid #E9Af85; padding-bottom: 1px; display: inline-block;">7:00PM to 9:00PM</p>
                            </div>
                        </div>
        ...
        <section id="participating-banks" class="fullscreen background-white bank_logo_area" style="position: relative; ">
            <div class="top-border"></div>
            <div class="container">
                <h2 style="font-family: lintel-bold; font-size: 14px; margin: 0; text-align: center;">CONNECTING PARTNERS TO POWERFUL GROWTH</h2>
                <hr class="space">
        ...
        <!-- contact us section -->
        <section id="contact-us" class="fullscreen text-light" style="background: transparent url(images/bg-3.jpg); background-repeat: no-repeat; background-size: cover; background-position: bottom;" >
                <div class="top-border"> </div>
                <div class="container bbdr d-md-flex justify-content-between">
                    <div class="col-md-6">
                        <div>
                                ...
                                <!--<p style="font-family: lintel-bold; font-weight:bold; font-size: 15px; margin: 0; text-align: left;">Octomer 23, 2024</p>-->
                        ...
                        <div class="d-md-flex">
                            <div class="contact text-sm-center col-md-4 d-flex align-items-center justify-content-center my-2"
                                    ...
                                    <ap style="color: white;">Event Date</ap>
                            </div>
                            <div class="col-md-1"></div>
                            <div class="contact text-sm-center col-md-4 d-flex align-items-center justify-content-center my-2" style="background-color:#2F8C95;">
                                    <ap style="color: white;">October 23, 2024</ap>
                            </div>
                        </div>
                        <div class="contact text-sm-center col-md-9 align-items-center justify-content-center my-2" style="background-color:#2F8C95">
                                <p style="color: white !important;">7:00PM to 9:00PM</p>
                        </div>
                        <div class="bdr py-3">
